<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowShopContent=true">
    ...
    <div class="shop-brief-modal" v-show="isShowShopContent">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isShowShopContent=false">
