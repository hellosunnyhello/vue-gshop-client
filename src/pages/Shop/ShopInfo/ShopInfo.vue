  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity" v-for="(support,index) in info.supports"
             :key="index">
          <div class="activity-item" :class="activityClasses[support.type]">
  ...
  export default {
    ...
    mounted (){
      this.$nextTick(()=>{
        ...
        this.shopPicScroll = new BScroll('.pic-wrapper',{
          click: true,
          scrollX: true,
        })
